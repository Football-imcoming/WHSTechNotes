...
# September 30, 2025
The "6,7" meme is based off a song called "Doot Doot", by a rapper called Skrilla. The tone kids use "6,7" for is exciting and happy!. People use the word "6,7" for when they're counting numbers. People use "6,7" because it's funny. How people use it in classrooms are when the teacher says it by accident or when it pops us on a lesson. so six seven.
